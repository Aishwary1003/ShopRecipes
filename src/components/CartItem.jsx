  ...
  return (
    <motion.div whileHover={{scale:1.1}}  transition={{duration:0.3}}  className=" CartItem flex  gap-12 w-full border-b-4 pb-8 ">
        ...
        <div>
          ...
          <h1 className="my-4  text-gray-400 font-normal text-[12px] text-left">A recipe is a set of instructions that describes how to prepare or make something, especially a dish of prepared food. </h1>
          <div className=" w-full flex justify-between">
            <p className="text-emerald-500 font-bold">$2</p>
